...
enum class DashboardCardType(val sharedPreferencesKey: SharedPreferencesUtil.Key, val labelStringKey: Int, val defaultIsHidden: Boolean) {
    ...
    WEIGHT_TENDENCY(SharedPreferencesUtil.Key.HIDE_WEIGHT_TENDENCY, R.string.weight_tendency_title, false),
    ...
    BODY_FAT_TENDENCY(SharedPreferencesUtil.Key.HIDE_BODY_FAT_TENDENCY, R.string.body_fat_tendency_title, true),
