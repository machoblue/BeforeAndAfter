    ...
    override fun onProgress(status: BackupTask.BackupStatus) {
        ...
        when (status.statusCode) {
            BackupTask.BackupStatus.BACKUP_STATUS_CODE_SAVING_RECORDS -> {
                title = context.getString(R.string.backup_status_message_title_format).format(context.getString(R.string.backup_status_message_title_saving_records), 1, 2)
                progress = 10
            }
            BackupTask.BackupStatus.BACKUP_STATUS_CODE_SAVING_IMAGES -> {
                title = context.getString(R.string.backup_status_message_title_format).format(context.getString(R.string.backup_status_message_title_saving_images), 2, 2)
